...
python main.py analyze --file data/stories/story_day1_example.txt
...
- Files are saved in the `data/stories/` directory
- Old files with the previous naming convention (`story_phaseN_*`) are automatically moved to `data/stories/archive/`
...
- `story_prompt_template.txt`: Controls how stories are generated, including vocabulary and formatting
